...
const OurNumbers = () => {
    return (
        <div className=' bg-[#FFFFFF]'>
            <div className='xl:max-w-[1000px] pt-[94px] pb-[120px] px-5  sm:px-10 lg:px-[100px] w-full flex flex-col  mx-auto '>
                ...
                <div className='flex flex-wrap justify-center text-center sm:text-start sm:flex-row sm:justify-between mt-[84px] gap-[30px] animate-on-scroll'>
